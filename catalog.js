    ...
    return `
        <div class="col">
            <div class="card shadow-sm h-100 rounded-0 d-flex flex-column" style="max-width: 350px">
                <img src="${anime.image}" class="bd-placeholder-img card-img-top" style="max-width: 100%; max-height: 400px; object-fit: contain;" alt="Anime image"/>
                <div class="card-body">
...
const animeList = [
    ...
    { image: './images/Frieren.jpg', text: 'Frieren', smallText: 'Enter text' },
    { image: './images/Eva.jpg', text: 'Evangelion', smallText: 'Enter text' },
    { image: './images/VEG.jpg', text: 'VEG', smallText: 'Enter text' },
];
